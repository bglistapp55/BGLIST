...
<form action="confirmar_mod_categoria.php" method="post" class="mt-3" id="r_usuarios" >
        ...
        <!-- <div class="mb-3">
          ...
          <div class="mb-3 mt-3 p-1">
            ...
            <input type="usuario_id" class="form-control" id="co" placeholder="Ingrese el usuario id para esta categoria" value="<?php echo $row["usuario_id"];?>" name="usuario_id">
          </div>
