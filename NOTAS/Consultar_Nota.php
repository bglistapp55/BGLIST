...
<body>
    ...
    <?php
        ...
        if(!empty($_POST)){//si el formulario se envía vacio
            ...
            if(!empty($valor)){
                $where = "Where  contenido like '%$valor%'";
            }
     ...
     ?>
            ...
            <tr>
                ...
                <td><a href="modificar_nota.php?contenido=<?php echo $row["id"]; ?>">
                    <i class='fas fa-edit' style='font-size:36px; color:black'></i></a>
                    <a href="#" data-href="eliminar_nota.php?contenido=<?php echo $row["id"]; ?>"
        ...
        <button><a href="../NOTAS/registrarse4.php" class="form__link">Agregar</a></p></button>
