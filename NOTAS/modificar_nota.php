...
<form action="confirmar_mod_nota.php" method="post" class="mt-3" id="r_usuarios" >
        <h1 class="text-center">Modificar Notas</h1>
        <!-- <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="contenido" placeholder="ingrese un contenido para la nota" value="<?php echo $row["contenido"];?>" name="contenido">
          </div>
