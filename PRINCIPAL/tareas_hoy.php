...
// Consulta para obtener las tareas de hoy
...
if ($resultado->num_rows > 0) {
    ...
    echo "<p class='tasks__empty-message'>No hay tareas para hoy.</p>";
}

// Aquí puedes incluir cualquier otra funcionalidad adicional si es necesario
?>