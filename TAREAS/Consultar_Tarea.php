...
<body>
    ...
    <?php
        ...
        if(!empty($_POST)){//si el formulario se envía vacio
            $valor = $_POST['nom'];
            if(!empty($valor)){
                $where = "Where  nombre_tarea like '%$valor%'";
            }
     ...
     ?>
            ...
            <tr>
                ...
                <td><a href="modificar_tarea.php?nombre_tarea=<?php echo $row["id"]; ?>">
                    <i class='fas fa-edit' style='font-size:36px; color:black'></i></a>
                    <a href="#" data-href="eliminar_tarea.php?nombre_tarea=<?php echo $row["id"]; ?>"
        ...
        <button><a href="../TAREAS/registrarse3.php" class="form__link">Agregar</a></p></button>
